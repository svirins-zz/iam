...
type homezvrzdeviamsrctemplatespageJs1124644608QueryVariables = Exact<{
  slug: Scalars['String'];
}>;


type homezvrzdeviamsrctemplatespageJs1124644608Query = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'slug' | 'price' | 'seotitle' | 'seodescription' | 'text'>> } }> }, readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: Pick<File, 'publicURL'> }> } };
